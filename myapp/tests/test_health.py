...
from fastapi.testclient import TestClient # TestClient, which matches the FastAPI testing pattern with pytest.
import pytest

from myapp.main import app  # Uses src/myapp/main.py The FastAPI app instance is called app at the bottom of that file.
from myapp.main import state 
